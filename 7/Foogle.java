...
//consult https://www.youtube.com/watch?v=SfhVFgKF5yU
...
public class Foogle
{
  ...
  //create a method named foo with two parameters arraylist and integer
  //start at index 0 and go through the array to search for target
