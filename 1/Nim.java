...
public class Nim{
  public static void main(String[] args){
    ...
    {
     // random is in the range 1-3 (including 3). T
     //The parentheses are necessary!
     //Source: https://csawesome.runestone.academy/runestone/books/published/
     //csawesome/Unit2-Using-Objects/topic-2-9-Math.html
